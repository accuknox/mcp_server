...
class AccuKnoxClient:
    ...
    async def fetch_assets(
        self, asset_id=None, type_name=None, type_category=None, 
        label_name=None, region=None, cloud_provider=None,
        ...
        if type_category: params["type_category"] = type_category
        if label_name: params["label_name"] = label_name
        if region: params["region"] = region
        if cloud_provider: params["cloud_provider"] = cloud_provider
...
async def search_assets(
    ...
    try:
        response = await client.fetch_assets(
            ...
            page=1, page_size=limit if return_type == "list" else 1000
        )
